...
**Layout:** `visioflow-toast.exe` must sit beside `visioflow.exe` in release zips and installs. See [[Distribution-and-Release]].
...
## Routing events that drive toasts

| Event | Example stderr message |
|-------|------------------------|
...
- Capture flag reference: [[Capture]]
